...
class UtilTests(TestCase):
    ...
    def setUp(self):
        ...
        self.value_benefit = BenefitFactory(type=Benefit.FIXED, range=self._range, value=self.seat_price / 3)
    ...
    def test_format_benefit_value(self):
        ...
        self.assertEqual(benefit_value, currency(self.seat_price / 3))
